...
let movies = [
    new Movie("Shivaji", "AVM Studio", "PG13"),
    new Movie("Robo", "Vahini Studio", "R"),
    new Movie("Theeran", "EVP Film City"),
    new Movie("Maran", "Chennai Studio", "PG")
];
